export default [
  ...
  //Luminance
  {
    ...
    combat: {
      ...
      yellowPing: "Enhances the weapon and increases the hit count of Basic Attacks. Based on the number of orbs pinged, deals 30% / 40% / 50% Physical DMG per hit up to 16/20/32 times for 2.5/3.5/5 seconds.",

      bluePingIcon: require("../../assets/Images/Luminance/BlueOrb.png"),
      bluePing: "Deploys a particle array at the target location, marking all enemies within. The array lasts 3/6/9 seconds, dealing 100% / 200% / 300% Physical DMG based on the number of orbs pinged and dragging the targets in range once per second.",

      // Skills
      basicAttack: "Basic Attack: Launches an energy attack, dealing 520% Physical DMG in total.",
      basicAttackIcon: require("../../assets/Images/Luminance/BasicAttack.png"),

      signature: "Signature Move: Costs 100 Energy. Deploys a wide-ranged energy field and uses Light Penalty that deals 150% Physical DMG at random enemies in the area. Physical DMG Resistance of party members in the area increases by 75%.",
      ...
      ssRank: "Passive: Extra DMG Bonus against enemies in Gray Raven Field increases by 15%.",
      ...
      sssPlusRank: "Passive: After using a Signature Move, Extra DMG of all party members increases by 15% for 5 seconds.",
      sssPlusRankIcon: require("../../assets/Images/Luminance/SSSPlus.png"),
      hiddenSkill: "Hitting marked enemies has a chance to activate Light Penalty that deals Physical DMG. When Light Penalty is activated for the 5th time or when a 3-Ping, trigger a self-centered area healing effect.",
      hiddenSkillIcon: require("../../assets/Images/Orb.png"),
    },
    memories: {
      set1: "Set 1",
  ...
  //Entropy
  {
    ...
    combat: {
      ...
      yellowPingIcon: require("../../assets/Images/Lotus/YellowOrb.png"),
      yellowPing: "Moves and shoots at the target. Based on the number of orbs pinged, deals 180% / 440% / 700% Physical DMG and marks the target for 4/6/8 seconds. Attacking a marked target will carry out an additional shot that deals 20% / 40% / 60% Physical DMG based on the number of orbs pinged. When marking an already marked target, the mark with the highest number of pings will replace the lower one.",

      bluePingIcon: require("../../assets/Images/Lotus/BlueOrb.png"),
      bluePing: "Fires an energy projectile forward, dealing 100% / 200% / 300% Physical DMG based on the number of orbs pinged. An energy ring will be generated after the projectile hits a target or reaches a certain distance. When the energy ring is deployed, it slightly pulls the enemy towards the centre once. Based on the number of orbs pinged, enemies in the ring take 24% / 48% / 72% Physical DMG per second for 3/4/5 seconds.",

      // Skills
      basicAttack: "Basic Attack: Fires consecutively at the target, dealing 825% Physical DMG in total.",
      basicAttackIcon: require("../../assets/Images/Lotus/BasicAttack.png"),

      signature: "Signature Move: Costs 100 Energy. Calls in fire support from long-rage energy cannons, dealing 400% Physical DMG per shot.",
      signatureIcon: require("../../assets/Images/Lotus/Signature.png"),
      ...
      leader: "Physical DMG and Moment Speed of all party members increased by 15% and 10%.",
      leaderIcon: require("../../assets/Images/Lotus/Leader.png"),

      ssRank: "Passive: Extra DMG Bonus increases by 15% when attacking a target within an energy ring.",
      ssRankIcon: require("../../assets/Images/Lotus/SS.png"),

      sssRank: "Passive: Extra DMG Bonus increases by 20% when attacking a target by Backstep Firing.",
      sssRankIcon: require("../../assets/Images/Lotus/SSS.png"),

      sssPlusRank: "Passive: Increases Physical DMG by 10% for 5 seconds after a 3-Ping, can be stacked up to 3 times. Duration refreshes when stacks overlap.",
      sssPlusRankIcon: require("../../assets/Images/Lotus/SSSPlus.png"),
      hiddenSkill: "When pinging a Red Orb after any 3-Ping, summons multiple space bullets to assist in shooting.",
      hiddenSkillIcon: require("../../assets/Images/Orb.png"),
    },
    memories: {
      set1: "Set 1",
  ...
  //Ember
  {
    ...
    combat: {
      ...
      yellowPing: "Leaps forward and hammers the target with a gun. Total damage taken by attacks reduces by 30% while using this skill. Deals 180% / 360% / 540% Physical DMG to nearby targets based on the number of orbs pinged. Enhanced: Deals 30% / 60% / 90% Fire DMG per hit based on the number of orbs pinged.",

      bluePingIcon: require("../../assets/Images/Ember/BlueOrb.png"),
      bluePing: "Calls for a flying laser cannon and deals 6% / 12% / 18% Physical DMG per hit based on the number of orbs pinged. The cannon deals 20% / 40% / 60% Physical DMG per attack based on the number of orbs pinged. If multiple cannons are available, the most powerful one takes priority. Enhanced: Deals 30% / 60% / 90% Fire DMG per hit based on the number of orbs pinged.",

      // Skills
      basicAttack: "Basic Attack: Launches consecutive attacks at the target, dealing 720% Physical DMG in total. Enhanced: Basic Attacks deal Fire DMG.",
      basicAttackIcon: require("../../assets/Images/Ember/BasicAttack.png"),

      signature: "Signature Move: Costs 100 Energy. Shoots a laser at the ground by 200% Fire DMG and leaves a path of fire for 5 seconds in the end. All enemies in the path take 200% Fire DMG per second.",
      ...
      leader: "When party members are of 3 different classes, ATK increases by 10% and ATK of Attacker increases by 5%.",
      leaderIcon: require("../../assets/Images/Ember/Leader.png"),

      ssRank: "Passive: Extra Fire DMG Bonus increases by 10% after entering Thermal mode.",
      ...
      sssPlusRank: "Passive: Reduces Fire DMG Resistance of enemies that took burning damage from a Signature Move by 15% for 5 seconds.",
      sssPlusRankIcon: require("../../assets/Images/Ember/SSSPlus.png"),
      hiddenSkill: "Gains thermal energy based on the skill level (3% per), and also by using certain skills. All skills become Enhanced when thermal energy is above 50%. Fire DMG increases when in Thermal Mode.",
      hiddenSkillIcon: require("../../assets/Images/Orb.png"),
    },
    memories: {
      set1: "Set 1",
  ...
  //Pulse
  {
    ...
    combat: {
      ...
      yellowPing: "Deals damage twice by flipping forward and slashes with a chainsaw. Deals 100% / 200% Physical DMG per hit if this is not a 3-Ping. Deals 200% Fire DMG per hit and create a rotating fire ring that deals 30% Fire DMG up to 12 times.",

      bluePingIcon: require("../../assets/Images/Pulse/BlueOrb.png"),
      bluePing: "Unleashes energy that interrupts enemy attacks and does a heavy strike that deals damage 3 times to nearby enemies. Deals 50% / 100% / 200% Physical DMG per hit based on the number of orbs pinged. Gains a shield equal to 5% / 7.5% / 10% of your maximum HP for 5 seconds and gains Super Armor when the shield is present. Physical DMG is converted to Fire DMG if ths is a 3-Ping.",

      // Skills
      basicAttack: "Basic Attack: Launches consecutive attacks with a sawblade, dealing 620% Physical DMG in total.",
      basicAttackIcon: require("../../assets/Images/Pulse/BasicAttack.png"),

      signature: "Signature Move: Costs 30 Energy. Nanami charges at the target and deals 900% Fire DMG to enemies in the path.",
      ...
      leader: "DEF and Fire Resistance of all party members increases by 15% and 10%.",
      leaderIcon: require("../../assets/Images/Pulse/Leader.png"),

      ssRank: "Passive: Has a 30% chance to cause an explosion that deals 25% Fire DMG when doing Fire DMG attacks.",
      ssRankIcon: require("../../assets/Images/Pulse/SS.png"),

      sssRank: "Passive: Gains Super Armor after using a Signature Move, Extra DMG Resistance and Fire DMG increase by 10% and 15% for 8 seconds",
      sssRankIcon: require("../../assets/Images/Pulse/SSS.png"),

      sssPlusRank: "Passive: After using a Signature Move, Extra DMG Bonus increases by 15% for 8 seconds.",
      sssPlusRankIcon: require("../../assets/Images/Pulse/SSSPlus.png"),
      hiddenSkill: "Nanami enters Overclocking state after a Signature Move, Basic Attacks will be converted into Overclocking attacks that deal Fire DMG. Fire Resistance of targets hit will be reduced.",
      hiddenSkillIcon: require("../../assets/Images/Orb.png"),
    },
    memories: {
      set1: "Set 1",
  ...
  //Tenebrion
  {
    ...
    combat: {
      ...
      redPing:
        "Unleashes a cross slash at the target, dealing 200% / 400% / 600% Physical DMG and 40% / 80% / 160% Extra Dark DMG based on the number of orbs pinged. Dark Form: Swings at the target ahead, dealing 800% / 1000% / 1200% Dark DMG based on the number of orbs pinged.",

      yellowPingIcon: require("../../assets/Images/Tenebrion/YellowOrb.png"),
      yellowPing: "Charges at the target, dealing 200% / 400% / 600% Physical DMG and 40% / 80% / 120% Extra Dark DMG based on the number of orbs pinged. When charging, reduces total damage taken from frontal attacks by 30% and becomes immune to control effects. Dark Form: Charges at the target, dealing 600% / 750% / 900% Dark DMG based on the number of orbs pinged. When Charging, reduces total damage taken from frontal attacks by 30% and becomes immune to control effects.",

      bluePingIcon: require("../../assets/Images/Tenebrion/BlueOrb.png"),
      bluePing: "Spins and slashes the target airborne, dealing 140% / 280% / 420% Physical DMG and 40% / 80% / 120% Extra Dark DMG based on the number of orbs pinged. Pulls the target while spinning. Dark Form: Hits the ground with a fan-shaped blast that deals 480% / 600% / 720% Dark DMG based on the number of Pings and stuns the target for 3/4/5 seconds.",

      // Skills
      basicAttack: "Basic Attack: Attack consecutively with your greatsword, dealing 560% Physical DMG in total. Dark Form: Launches consecutive attacks at the target with Dark Blade, dealing 900% Dark DMG in total.",
      basicAttackIcon: require("../../assets/Images/Tenebrion/BasicAttack.png"),

      signature: "Signature Move: Enters Dark Form when Energy is over 60. Transforms all skill forms and gains Super Armor. Costs 8 Energy per second when in Dark Form. The mode ends when Energy is used up. Dark DMG increases by 20% when in Dark Form.",
      ...
      leader: "When party members are of 3 different classes, Elemental DMG and Physical DMG increases by 10% and 5%.",
      leaderIcon: require("../../assets/Images/Tenebrion/Leader.png"),

      ssRank: "Passive: Extra DMG Resistance increases by 20% when in Dark Form.",
      ...
      hiddenSkill: "Performs a 3-Ping for 10 Energy. Increases Physical and Dark Resistance when in Dark Form.",
      hiddenSkillIcon: require("../../assets/Images/Orb.png"),
    },
    memories: {
      set1: "Set 1",
  ...
  //Crimson Abyss
  {
    ...
    combat: {
      ...
      yellowPing: "Charges forward and drives through enemies, dealing 250%/500%/750% Physical DMG to enemies in the path based on the number of orbs pinged.",

      bluePingIcon: require("../../assets/Images/CrimsonAbyss/BlueOrb.png"),
      bluePing: "Boosts energy supply for 5 seconds and increases Movement Speed by 20% / 30% / 50% based on the number of orbs pinged. Deals 4% / 8% / 12% Physical DMG twice when attacking. When unleashing Sword Waves, Extra DMG will be enhanced into extra Sword Waves that deal 8%/16%/24% Physical DMG per hit.",

      // Skills
      basicAttack: "Basic Attack: Attacks the target in 5 sword styles. Each attack deals 80% / 100% / 120% / 270% / 280% Physical DMG. Can immediately perform the 3rd move of Basic Attack after dodging.",
      basicAttackIcon: require("../../assets/Images/CrimsonAbyss/BasicAttack.png"),

      signature: "Signature Move: Costs 85 Energy. Slashes target ahead, dealing 2600% Physical DMG in total.",
      ...
      leader: "ATK and CRIT of all Attacker Constructs increases by 10% and 5%.",
      leaderIcon: require("../../assets/Images/CrimsonAbyss/Leader.png"),

      ssRank: "Passive: When performing a Red 3-Ping, Physical DMG increases by 10% for 4 seconds.",
      ssRankIcon: require("../../assets/Images/CrimsonAbyss/SS.png"),

      sssRank: "Passive: Extra DMG increases by 5%. Gains 2 Signal Orbs when the Blade Will mode ends.",
      sssRankIcon: require("../../assets/Images/CrimsonAbyss/SSS.png"),

      sssPlusRank: "Passive: Under the effects of pinging a Blue Orb, Physical DMG increases by 20%.",
  ...
  //Veritas
  {
    ...
    combat: {
      ...
      leader: "Lightning DMG increases by 10%. ATK of Attacker Constructs increases by 5%.",
      leaderIcon: require("../../assets/Images/Veritas/Leader.png"),

      ssRank: "Passive: Veritas's Extra DMG Bonus to targets pierced by her Red Orb skill increases by 10% for 8 seconds.",
      ssRankIcon: require("../../assets/Images/Veritas/SS.png"),

      sssRank: "Passive: Veritas' Extra DMG Bonus to targets within her Yellow Orb skill's zone of lightning increases by 15%.",
      sssRankIcon: require("../../assets/Images/Veritas/SSS.png"),

      sssPlusRank: "Passive: Lightning DMG increases by 20% while Core Passive is active.",
  ...
  //Plume
  {
    ...
    combat: {
      ...
      leader: "All team members' Ice DMG increases by 10%. ATK of Attacker Constructs increases by 5%.",
      leaderIcon: require("../../assets/Images/Lotus/Leader.png"),

      ssRank: "Passive: After Frigid Roundabout strikes hits a target, the target takes 10% extra DMG from you for 8s.",
      ssRankIcon: require("../../assets/Images/Lotus/SS.png"),

      sssRank: "Passive: Gain max Energy and 2 Signature Points at the start of battle. While you still have Energy in Arctic Form, Extra DMG Bonus of Signal Orb Skills increases by 5%.",
      sssRankIcon: require("../../assets/Images/Lotus/SSS.png"),

      sssPlusRank: "Passive: Ice DMG increases by 20% while Core Passive is active.",
      sssPlusRankIcon: require("../../assets/Images/Lotus/SSSPlus.png"),
  ...
  //Arctic
  {
    ...
    combat: {
      ...
      yellowPing: "Raises the shield the charges towards the target followed by a spear attack, dealing 220% / 440% / 660% Physical DMG and gain 3% / 6% / 10% HP worth of shield for 5 seconds. Gains Super Armor during the move.",

      bluePingIcon: require("../../assets/Images/Arctic/BlueOrb.png"),
      bluePing: "Tosses and retrieves the shield, dragging enemies and dealing 220% / 440% / 660% Physical DMG and applying Spear of Insight for 8 seconds.\nSpear of Insight: Target's Physical DEF is reduced by 20%.",

      // Skills
      basicAttack: "Basic Attack: Continuously attacks the target with the spear and shield, dealing a total of 950% Physical DMG. Press and hold the Basic Attack button to charge the railgun, dealing 200% / 370% Physical DMG based on the hold duration. DMG received is reduced by 30% while charging.",
      basicAttackIcon: require("../../assets/Images/Arctic/BasicAttack.png"),

      signature: "Signature Move: Costs 80 Energy. Soars into the sky and fires the ion cannon towards the ground. Nearby enemies are drawn together during the charging process. Deal a total of 2480% Physical DMG as the explosion occurs.",
      ...
      leader: "All team members' DEF increases by 15%. Attack of Tank Constructs increases by 5%.",
      leaderIcon: require("../../assets/Images/Arctic/Leader.png"),

      ssRank: "Passive: QTE triggers Spear of Insight for 8 seconds. Rosetta deals 10% bonus DMG to targets struck by Red Orb for 8 seconds.",
  ...
  //Laurel
  {
    ...
    combat: {
      ...
      yellowPing: "Continuously channels the flow of energy, generates up to 4 spikes at the target's location, dealing 220% / 440% / 660% Physical DMG. DMG is converted to Dark element when it is a 3-Ping. Gains Super Armor during the move.",

      bluePingIcon: require("../../assets/Images/Laurel/BlueOrb.png"),
      bluePing: "Unleashes a virus network field for 3 seconds, dealing 200% / 400% / 600% Physical DMG. DMG is converted to Dark element when it is a 3-Ping. The field will automatically follow the nearest target, otherwise it accompanies the character instead. Character is able to move while triggering the skill.",

      // Skills
      basicAttack: "Basic Attack: Unleashes a flurry of attacks with spheres and spikes, dealing a total of 470% Physical DMG. Attack with a longsword and spear instead during Annihilation Mode, dealing a total of 950% Dark DMG. Attacking after dodging deals 300% Dark DMG. Signal Orbs will not be generated during Annihilation Mode.",
      basicAttackIcon: require("../../assets/Images/Laurel/BasicAttack.png"),

      signature: "Signature Move: Costs 150 Energy. Continuously alters the gravity in a large area ahead, dealing 2880% Dark DMG to all targets within. Performing Signature Move during Annihilation Mode drains all Annihilation points and exits Annihilation Mode.",
      ...
      leader: "All team members' Dark DMG increases by 10%, Attack of Attacker constructs increases by 5%.",
      ...
      sssRank: "Passive: Dark DMG increases by 5% during Annihilation Mode. DMG bonus persists for 4 seconds after exiting Annihilation Mode. Trigger Matrix when entering Annihilation Mode with a full gauge, 12 seconds cooldown.",
      sssRankIcon: require("../../assets/Images/Laurel/SSS.png"),

      sssPlusRank: "Passive: Signature Move gains a DMG bonus of 15% / 30% / 45% / 60% / 75% corresponding to the number of Annihilation Orbs expended.",
  ...
  //2b
  {
    ...
    combat: {
      ...
      yellowPing: "Moves forward and brandishes the light weapon, dealing 200% / 400% / 600% Physical DMG, dragging enemies along the way. Apply Withdraw to enemies struck, reducing Attack by 60% for 12 seconds. Gains Super Armor during the move. Direction of attack can be navigated with the directional stick.",

      bluePingIcon: require("../../assets/Images/2B/BlueOrb.png"),
      bluePing: "Unleashes an illusion using the POD, dealing 140% / 280% / 420% Physical DMG to nearby enemies. Gains Super Armor during the move.",

      // Skills
      basicAttack: "Basic Attack: Continuously attacks with the light weapon, dealing a total of 840% Physical DMG. Go into sprint after dodging. Triggering Basic Attack while sprinting deal 290% Physical DMG.",
      basicAttackIcon: require("../../assets/Images/2B/BasicAttack.png"),

      signature: "Signature Move: Costs 80 Energy. Slashes forward after charging the heavy weapon, dealing a total of 800% Physical DMG. When the final hit lands on the target, triggers the second attack phase and slashes forward with the heavy weapon, dealing 1800% Physical DMG.",
      ...
      leader: "2B, 9S and A2 within the team receive an increased 8% Physical DMG and 25 Energy at the start of battle.",
      leaderIcon: require("../../assets/Images/2B/Leader.png"),

      ssRank: "Passive: When 2B, 9S or A2 activates Signature Move, 9S and A2's Critical Rate increases by 10% and 2B's Critical Rate increases by 25% for 12 seconds.",
      ...
      sssPlusRank: "Passive: DMG received is reduced by 30% during skill activations. Triggering Blue Orbs grant 0.3 seconds of invincibility. Physical DMG increases by 10% (20% when 9S and A2 are in the team) during Combat Stance.",
  ...
  //9S
  {
    ...
    combat: {
      ...
      yellowPing: "Unleashes a deceleration field using the pod, dealing 190% / 380% / 570% Physical DMG and halting all enemies within the area for 0.6/1.2/2.4 seconds.",

      bluePingIcon: require("../../assets/Images/9S/BlueOrb.png"),
      bluePing: "Unleashes an expanding electric ring using the pod, dealing 180% / 360% / 540% Physical DMG to targets who come into contact with the ring while allies are healed for 40% / 80% / 120% of 9S' attack.",

      // Skills
      basicAttack: "Basic Attack: Attacks forward continuously, dealing a total of 860% Physical DMG. Sprint can be performed after dodging. Attacking while sprinting deals 240% Physical DMG. Basic Attacks do not generate orbs. Orbs are automatically generated every 2.5 seconds.",
      basicAttackIcon: require("../../assets/Images/9S/BasicAttack.png"),

      signature: "Signature Move: Costs 80 Energy. Commences hacking on the target. Deal 2600% Physical DMG when the hack is successful.\n(Minigame can be toggled to skip in the Character Skills page).",
      ...
      leader: "2B, 9S and A2 within the team receive an increased 8% Physical DMG and 10% DMG received.",
      leaderIcon: require("../../assets/Images/9S/Leader.png"),

      ssRank: "Passive: Possession limit of Overclock Indicator is increased by 1. Gains a random Overclock Indicator Orb when entering the field. QTE and Blue Orbs will apply E-Drug to 2B and A2.\nE-Drug: Physical DMG increases by 10% for 8 seconds.",
      ssRankIcon: require("../../assets/Images/9S/SS.png"),

      sssRank: "Passive: Signal Orb generation speed is increased to 1.5 seconds. Overclock Indicator DMG increases by 50%. E-Drug effect increases to 20% for 12 seconds.",
      sssRankIcon: require("../../assets/Images/9S/SSS.png"),

      sssPlusRank: "Passive: Triggering Overclock Indicator grants 0.3 seconds of invulnerability and Physical DMG increases by 10% for 5 seconds. (Effect is increased to 20% when 2B and A2 are in the team).",
  ...
  //A2
  {
    ...
    combat: {
      ...
      leader: "2B, 9S and A2 within the team receive an increased 8% Physical DMG and dodge limit increases by 200.",
      leaderIcon: require("../../assets/Images/A2/Leader.png"),

      ssRank: "Passive: Always gain 50% POD: Shield upon entry into battle. The pod will automatically launch honing missiles every 4 seconds during Berserk mode (off-field included). Additionally, when 2B and 9S are present in the team, the next active character receives an increased 10% Physical DMG until Berserk mode ends.",
      ssRankIcon: require("../../assets/Images/A2/SS.png"),

      sssRank: "Passive: DMG decreases by 70% to enemies within the gravity field. Pod honing missiles DMG increases by 100%. Provoke (DEF down) effect is increased to 40%.",
      sssRankIcon: require("../../assets/Images/A2/SSS.png"),

      sssPlusRank: "Passive: The HP threshold of Berserk mode is lowered to 30%. When POD: Shield is active during Berserk mode, the Signature Move gauge drains at 2.5% HP per second instead and DMG increases by 10%.",
  ...
  //Glory
  {
    ...
    combat: {
      ...
      yellowPing: "Draws the blade and leaps towards the enemy, striking them and dealing 190% / 380% / 570% Physical DMG.\n\nWhen Shield of Glory is more than 50%, performing a 3-Ping will consume 50% of it and deal 740% Ice DMG instead and also grants Frosted Body for a fixed duration during the attack. Incoming attacks are negated and enemies are slowed when struck while Frosted Body is active and also recovers 50% Shield of Glory.",

      bluePingIcon: require("../../assets/Images/Glory/BlueOrb.png"),
      bluePing: "Boosts forward with the thrusters and strikes with the charged weapon, dealing 170% / 340% / 510% Physical DMG.\n\n When Shield of Glory is more than 50%, performing a 3-Ping will consume 50% of it and deal 740% Ice DMG instead and also grants Frosted Body for a fixed duration during the attack. Incoming attacks are negated and enemies are slowed when struck while Frosted Body is active and also recovers 50% Shield of Glory.",

      // Skills
      basicAttack: "Basic Attack: Attacks continuously with the gunblade, dealing a total of 750% Physical DMG. While Frigid Soul is active, Basic Attack is empowered into Frigid Assault, dealing a total of 900% Ice DMG and also gains Frosted Body for a fixed duration during the attack. Incoming attacks are negated and enemies are slowed when struck while Frosted Body is active and recovers 50% Shield of Glory. Frigid Assault does not generate Signal Orbs.",
      basicAttackIcon: require("../../assets/Images/Glory/BasicAttack.png"),

      signature: "Signature Move: Costs 80 Energy. Injects frigid air into the ground, causing a large freezing AOE, dealing 2300% Ice DMG to all enemies struck.",
      ...
      leader: "All team members' Ice DMG increases by 10%, Attack of Tank Constructs increases by 5%.",
      leaderIcon: require("../../assets/Images/Glory/Leader.png"),

      ssRank: "Passive: Signature Move DMG increases by 20%. DMG increases by 10% for 3-Pings performed with Frosted Body. The slow effect of Frosted Body is converted to Freeze, applying to all targets around the character.",
      ssRankIcon: require("../../assets/Images/Glory/SS.png"),

      sssRank: "Passive: Etching Frost effect increases by 10%. Recovers 100% Shield of Glory when struck while Frosted body is active and Attack increases by 10% for 5 seconds.",
      sssRankIcon: require("../../assets/Images/Glory/SSS.png"),

      sssPlusRank: "Passive: Retains 25% Shield of Glory and recover 40 Signature Move Energy when Frigid Soul is activated. Ice DMG increases by 20% during Frigid Soul. Freeze duration of Frosted Body increases by 1 second.",
  ...
  //Flare
  {
    ...
    combat: {
      ...
      yellowPing: "Spins around the spear, pulling enemies in and deals 190% / 380% / 570% Physical DMG.",

      bluePingIcon: require("../../assets/Images/Flare/BlueOrb.png"),
      bluePing: "Thrusts forward and pierces targets ahead, dealing 180% / 360% / 540% Physical DMG. DMG is converted to Lightning element on a 3-Ping.",

      // Skills
      basicAttack: "Basic Attack: Performs a series of spear attacks, dealing a total of 860% Physical DMG. Immediately performing Basic Attack after any 3-Ping will trigger a Follow-up, dealing 310% / 230% / 200% Lightning DMG for Red/Yellow/Blue Orbs respectively. Immediately enters the third combo after dodging.",
      basicAttackIcon: require("../../assets/Images/Flare/BasicAttack.png"),

      signature: "Signature Move: Costs 50 Energy. Hurls the spear at full force, dealing 1500% Lightning DMG ahead.",
      ...
      leader: "All team members' Lightning DMG increases by 10%, Attack of Tank Constructs increases by 5%.",
      leaderIcon: require("../../assets/Images/Flare/Leader.png"),

      ssRank: "Passive: QTE attacks will automatically be performed upon switching out, Signature Move Energy cost decreases by 20%. Thunderfall can be performed after activating Signature Move.",
      ssRankIcon: require("../../assets/Images/Flare/SS.png"),

      sssRank: "Passive: Gains Super Armor and reduces DMG taken by 50% when a shield is active. Interference Lightning Resistance reduction decreases to 25%. Signature Move Lightning DMG increases by 100%.",
      sssRankIcon: require("../../assets/Images/Flare/SSS.png"),

      sssPlusRank: "Passive: Thunderfall grants 20% HP of shield. Thunderfall Lightning DMG increases by 25%.",
  ...
  //Solaeter
  {
    ...
    combat: {
      ...
      yellowPing: "Liv activates her wings, moving in the direction of the current directional input, and releases a barrage of shining feathers, dealing 210% / 420% / 630% Physical DMG to the target and any nearby enemies based on the number of orbs pinged. Damage type is converted to Fire on 3-Ping.",

      bluePingIcon: require("../../assets/Images/Solaeter/BlueOrb.png"),
      bluePing: "Liv summons an energy matrix, dealing 200% / 400% / 600% Physical DMG to a rectangular area around the target based on the number of orbs pinged. Damage type is converted to Fire on 3-Ping. Enemies damaged by this attack will enter a Matrix state for 1.5/2/2.5 seconds based on the number of orbs pinged.",

      // Skills
      basicAttack: "Basic Attack: Using her scepter and wings, Liv fires a series of beam attacks, dealing 860% Physical DMG in total.",
      basicAttackIcon: require("../../assets/Images/Solaeter/BasicAttack.png"),

      signature: "Signature Move: Costs 80 Energy. Liv enters Radiant state for 7 seconds, polluting the space around her with the effects of her M.I.N.D. Instantly fill the Prayer gauge and obtain 6 random Signal Orbs (with a minimum of at least 1 set of three). At the end of the Radiant state, perform a Radiant Oath, dealing 1000% wide-area Fire DMG.\nWhile in Radiant state, double-tapping the Dodge button will enter Radiant Prayer Chant. In this state, pinging Signal Orbs will add stacks to a Radiant Prayer at a rate of 1/2/4 stacks depending on the number of Orbs pinged, up to a maximum of three 3-Pings. For each stack of Radiant Prayer, Liv gains a 0.5x DMG magnification.",
      ...
      class: "Switched-in active units gain 10% ATK and 10% Elemental Damage (Element of the Amplifier) for 10s.",
  ...
  //Capriccio
  {
    ...
    combat: {
      ...
      ssRank: "Passive: When Selena enters the field, she recovers HP equal to 30% of her Attack. When Selena enters Capriccio Zone and heals her allies, excess healing above full HP converts to Musical Protection, lasting for 3 seconds. When Selena is in Capriccio Zone, she gains a 10% increase in Dark DMG.",
      ssRankIcon: require("../../assets/Images/Capriccio/SS.png"),

      sssRank: "Passive: Amplifier Class skill effect increases by 100%, Dark Radiation’s Dark DMG increases by 20%. Core Passive - [Core Passive name] Extra DMG Bonus increases by 20%. Capriccio Zone’s healing ability lasts for 5 seconds more.",
      sssRankIcon: require("../../assets/Images/Capriccio/SSS.png"),

      sssPlusRank: "Passive: When team members perform 3-Pings, Selena gains 12 Signature Move Energy. Signature Move - [Signature Move name] Extra DMG Bonus increases by 50%.",
