export default [
  //Lotus
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory2: 'Zu Wenyuan',
        memory2ID: 14,
        image3: require('../../assets/Images/Memories/Gloria/image3.png'),
        memory3: 'Gloria',
        memory3ID: 29,
        ...
        memory5: 'Zu Wenyuan',
        memory5ID: 14,
        image6: require('../../assets/Images/Memories/Gloria/image3.png'),
        memory6: 'Gloria',
        memory6ID: 29,
      },
    },
  ...
  //Storm
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Da Vinci',
        memory2ID: 6,
        image3: require('../../assets/Images/Memories/Catherine/image3.png'),
        memory3: 'Catherine',
        memory3ID: 7,
      ...
      set2: {
        ...
        memory3: 'Patton',
        memory3ID: 12,
        image4: require('../../assets/Images/Memories/Darwin/image1.png'),
        memory4: 'Darwin',
        memory4ID: 3,
        image5: require('../../assets/Images/Memories/Patton/image2.png'),
        memory5: 'Patton',
        memory5ID: 12,
        image6: require('../../assets/Images/Memories/Darwin/image3.png'),
        memory6: 'Darwin',
        memory6ID: 3,
      },
    },
  ...
  //Eclipse
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory3: 'Erwin',
        memory3ID: 333,
        image4: require('../../assets/Images/Memories/Erwin/image1.png'),
        memory4: 'Erwin',
        memory4ID: 444,
        image5: require('../../assets/Images/Memories/Erwin/image2.png'),
        memory5: 'Erwin',
        memory5ID: 555,
  ...
  // Dawn
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Heisen',
        memory2ID: 2,
        image3: require('../../assets/Images/Memories/Heisen/image3.png'),
        memory3: 'Heisen',
        memory3ID: 2,
        image4: require('../../assets/Images/Memories/Frederick/image1.png'),
        memory4: 'Frederick',
        memory4ID: 11,
        image5: require('../../assets/Images/Memories/Heisen/image2.png'),
        memory5: 'Heisen',
        memory5ID: 2,
        image6: require('../../assets/Images/Memories/Frederick/image3.png'),
        memory6: 'Frederick',
      ...
      set2: {
        ...
        memory3: 'Heisen',
        memory3ID: 2,
        image4: require('../../assets/Images/Memories/Gloria/image1.png'),
        memory4: 'Gloria',
        memory4ID: 29,
        image5: require('../../assets/Images/Memories/Heisen/image2.png'),
        memory5: 'Heisen',
  ...
  //Lux
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory3: 'Guinevere',
        memory3ID: 10,
        image4: require('../../assets/Images/Memories/Cottie/image1.png'),
        memory4: 'Cottie',
        memory4ID: 5,
        image5: require('../../assets/Images/Memories/Guinevere/image2.png'),
        memory5: 'Guinevere',
        memory5ID: 10,
        image6: require('../../assets/Images/Memories/Cottie/image3.png'),
        memory6: 'Cottie',
        memory6ID: 5,
      },
      set2: {
  ...
  //Palefire
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory3: 'Einsteina',
        memory3ID:8,
        image4: require('../../assets/Images/Memories/Shakespeare/image1.png'),
        memory4: 'Shakespeare',
        memory4ID: 1,
        image5: require('../../assets/Images/Memories/Shakespeare/image2.png'),
        memory5: 'Shakespeare',
        memory5ID: 1,
        image6: require('../../assets/Images/Memories/Shakespeare/image3.png'),
        memory6: 'Shakespeare',
        memory6ID: 1,
      },
      set2: {
        ...
        memory2: 'Hanna',
        memory2ID: 4,
        image3: require('../../assets/Images/Memories/Hanna/image3.png'),
        memory3: 'Hanna',
        memory3ID: 4,
        image4: require('../../assets/Images/Memories/Darwin/image1.png'),
        memory4: 'Darwin',
        memory4ID: 3,
        image5: require('../../assets/Images/Memories/Hanna/image2.png'),
        memory5: 'Hanna',
        memory5ID: 4,
        image6: require('../../assets/Images/Memories/Darwin/image3.png'),
        memory6: 'Darwin',
  ...
  //Nightblade
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Patton',
        memory2ID: 12,
        image3: require('../../assets/Images/Memories/Darwin/image3.png'),
        memory3: 'Darwin',
        memory3ID: 3,
        image4: require('../../assets/Images/Memories/Patton/image1.png'),
        memory4: 'Patton',
        memory4ID: 12,
        image5: require('../../assets/Images/Memories/Patton/image2.png'),
        memory5: 'Patton',
        memory5ID: 12,
        image6: require('../../assets/Images/Memories/Patton/image3.png'),
        memory6: 'Patton',
        memory6ID: 12,
      },
      set2: {
  ...
  //Zero
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory2: 'Frederick',
        memory2ID: 11,
        image3: require('../../assets/Images/Memories/Frederick/image3.png'),
        memory3: 'Frederick',
        memory3ID: 11,
        image4: require('../../assets/Images/Memories/Darwin/image1.png'),
        memory4: 'Darwin',
        memory4ID: 3,
        image5: require('../../assets/Images/Memories/Frederick/image2.png'),
        memory5: 'Frederick',
        memory5ID: 11,
        image6: require('../../assets/Images/Memories/Darwin/image3.png'),
        memory6: 'Darwin',
  ...
  //Entropy
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory4: 'Patton',
        memory4ID: 12,
        image5: require('../../assets/Images/Memories/Darwin/image2.png'),
        memory5: 'Darwin',
        memory5ID: 3,
        image6: require('../../assets/Images/Memories/Patton/image3.png'),
        memory6: 'Patton',
  ...
  //Ember
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Shakespeare',
        memory2ID: 1,
        image3: require('../../assets/Images/Memories/Shakespeare/image3.png'),
        memory3: 'Shakespeare',
        memory3ID: 1,
        image4: require('../../assets/Images/Memories/Cottie/image1.png'),
        memory4: 'Cottie',
      ...
      set2: {
        ...
        memory3: 'Hanna',
        memory3ID: 4,
        image4: require('../../assets/Images/Memories/Hanna/image1.png'),
        memory4: 'Hanna',
        memory4ID: 4,
        image5: require('../../assets/Images/Memories/Hanna/image2.png'),
        memory5: 'Hanna',
        memory5ID: 4,
        image6: require('../../assets/Images/Memories/Hanna/image3.png'),
        memory6: 'Hanna',
        memory6ID: 4,
      },
    },
  ...
  //Tenebrion
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory3: 'Einsteina',
        memory3ID: 8,
        image4: require('../../assets/Images/Memories/Bathlon/image1.png'),
        memory4: 'Bathlon',
        memory4ID: 13,
        image5: require('../../assets/Images/Memories/Bathlon/image2.png'),
        memory5: 'Bathlon',
        memory5ID: 13,
        image6: require('../../assets/Images/Memories/Bathlon/image3.png'),
        memory6: 'Bathlon',
        memory6ID: 13,
      },
      set2: {
        ...
        memory3: 'Hanna',
        memory3ID: 4,
        image4: require('../../assets/Images/Memories/Einsteina/image1.png'),
        memory4: 'Einsteina',
        memory4ID: 8,
        image5: require('../../assets/Images/Memories/Hanna/image2.png'),
        memory5: 'Hanna',
        memory5ID: 4,
        image6: require('../../assets/Images/Memories/Einsteina/image3.png'),
        memory6: 'Einsteina',
        memory6ID: 8,
      },
    },
  ...
  //Brilliance
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory3: 'Patton',
        memory3ID: 12,
        image4: require('../../assets/Images/Memories/Catherine/image1.png'),
        memory4: 'Catherine',
        memory4ID: 7,
        image5: require('../../assets/Images/Memories/Patton/image2.png'),
        memory5: 'Patton',
        memory5ID: 12,
        image6: require('../../assets/Images/Memories/Catherine/image3.png'),
        memory6: 'Catherine',
        memory6ID: 7,
      },
    },
  ...
  //Veritas
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory2: 'Heisen',
        memory2ID: 2,
        image3: require('../../assets/Images/Memories/Condelina/image3.png'),
        memory3: 'Condelina',
        memory3ID: 1,
        image4: require('../../assets/Images/Memories/Heisen/image1.png'),
        memory4: 'Heisen',
        memory4ID: 2,
        image5: require('../../assets/Images/Memories/Heisen/image2.png'),
        memory5: 'Heisen',
        memory5ID: 2,
        image6: require('../../assets/Images/Memories/Heisen/image3.png'),
        memory6: 'Heisen',
        memory6ID: 2,
      },
    },
  ...
  //Silverfang
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory3: 'Gloria',
        memory3ID: 29,
        image4: require('../../assets/Images/Memories/Guinevere/image1.png'),
        memory4: 'Guinevere',
        memory4ID: 10,
        image5: require('../../assets/Images/Memories/Guinevere/image2.png'),
        memory5: 'Guinevere',
        memory5ID: 10,
        image6: require('../../assets/Images/Memories/Guinevere/image3.png'),
        memory6: 'Guinevere',
        memory6ID: 10,
      },
    },
  ...
  //Rozen
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Guinevere',
        memory2ID: 10,
        image3: require('../../assets/Images/Memories/DaVinci/image3.png'),
        memory3: 'DaVinci',
        memory3ID: 6,
        image4: require('../../assets/Images/Memories/DaVinci/image1.png'),
        memory4: 'DaVinci',
      ...
      set2: {
        ...
        memory2: 'Bathlon',
        memory2ID: 13,
        image3: require('../../assets/Images/Memories/Bathlon/image3.png'),
        memory3: 'Bathlon',
        memory3ID: 13,
        image4: require('../../assets/Images/Memories/Cottie/image1.png'),
        memory4: 'Cottie',
  ...
  //Rigor
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory2: 'Leeuwenhoek',
        memory2ID: 15,
        image3: require('../../assets/Images/Memories/Hoek/image3.png'),
        memory3: 'Leeuwenhoek',
        memory3ID: 15,
        image4: require('../../assets/Images/Memories/Catherine/image1.png'),
        memory4: 'Catherine',
        memory4ID: 7,
        image5: require('../../assets/Images/Memories/Hoek/image2.png'),
        memory5: 'Leeuwenhoek',
        memory5ID: 15,
        image6: require('../../assets/Images/Memories/Catherine/image3.png'),
        memory6: 'Catherine',
  ...
  //Laurel
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory3: 'Darwin',
        memory3ID: 3,
        image4: require('../../assets/Images/Memories/Flamel/image1.png'),
        memory4: 'Flamel',
        memory4ID: 16,
        image5: require('../../assets/Images/Memories/Flamel/image2.png'),
        memory5: 'Flamel',
        memory5ID: 16,
        image6: require('../../assets/Images/Memories/Flamel/image3.png'),
        memory6: 'Flamel',
        memory6ID: 16,
      },
      set2: {
        ...
        memory2: 'Flamel',
        memory2ID: 16,
        image3: require('../../assets/Images/Memories/Flamel/image3.png'),
        memory3: 'Flamel',
        memory3ID: 16,
        image4: require('../../assets/Images/Memories/Cottie/image1.png'),
        memory4: 'Cottie',
  ...
  //2b
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory4: 'Cottie',
        memory4ID: 5,
        image5: require('../../assets/Images/Memories/Cottie/image2.png'),
        memory5: 'Cottie',
        memory5ID: 5,
        image6: require('../../assets/Images/Memories/Cottie/image3.png'),
        memory6: 'Cottie',
      ...
      set2: {
        ...
        memory2: 'Frederick',
        memory2ID: 11,
        image3: require('../../assets/Images/Memories/Cottie/image3.png'),
        memory3: 'Cottie',
        memory3ID: 5,
        image4: require('../../assets/Images/Memories/Frederick/image1.png'),
        memory4: 'Frederick',
  ...
  //XXI
  {
    ...
    combat: {
      ...
      redPing:
        "Leaps into the air and places a Twilight Field on target's location. The Twilight Field will pull all enemies in a large area once upon generation, dealing 100% / 200% / 300% Physical DMG. DMG is converted to Dark element on a 3-Ping. The field lasts for 1.5/3.5/6 seconds and continuously draws in enemies. \nNo. 21 enters Stagnation upon 3-Ping chains and is able to perform a Forced Evasion while unleashing 3 Twilight Matrices on the target. \n\nCollab Bot: Whenever No. 21 generates a Twilight Matrix, unleashes a gravitational wave on the Twilight Field, pulling targets in a large area once and dealing 70% Dark DMG.",

      yellowPingIcon: require("../../assets/Images/XXI/YellowOrb.png"),
      yellowPing:
        "Leaps according to the directional button and unleashes a Twilight Saw, dealing a total of 140% / 280% / 420% Physical DMG. DMG is converted to Dark element on a 3-Ping. \nNo. 21 enters Stagnation upon 3-Ping chains and is able to perform Forced Evasion while unleashing 3 Twilight Matrices on the target. ",
    ...
    memories: {
      ...
      set2: {
        ...
        memory4: 'Catherine',
        memory4ID: 7,
        image5: require('../../assets/Images/Memories/Catherine/image2.png'),
        memory5: 'Catherine',
        memory5ID: 7,
        image6: require('../../assets/Images/Memories/Catherine/image3.png'),
        memory6: 'Catherine',
  ...
  //Flare
  {
    ...
    memories: {
      ...
      set1:{
        ...
        memory3: 'Einsteina',
        memory3ID: 8,
        image4: require('../../assets/Images/Memories/Tifa/image1.png'),
        memory4: 'Tifa',
        memory4ID: 17,
        image5: require('../../assets/Images/Memories/Tifa/image2.png'),
        memory5: 'Tifa',
        memory5ID: 17,
        image6: require('../../assets/Images/Memories/Tifa/image3.png'),
        memory6: 'Tifa',
        memory6ID: 17,
      },
      set2: {
  ...
  //Solaeter
  {
    ...
    memories: {
      ...
      set2: {
        ...
        memory3: 'Darwin',
        memory3ID: 3,
        image4: require('../../assets/Images/Memories/Elizabeth/image1.png'),
        memory4: 'Elizabeth',
        memory4ID: 18,
        image5: require('../../assets/Images/Memories/Elizabeth/image2.png'),
        memory5: 'Elizabeth',
        memory5ID: 18,
        image6: require('../../assets/Images/Memories/Elizabeth/image3.png'),
        memory6: 'Elizabeth',
        memory6ID: 18,
      },
    },
   ...
   //Ornate
   {
    construct_Battle: 'Transcendant',
      ...
      memories: {
        ...
        set1:{
          set1Name: "General",
          image1: require('../../assets/Images/Memories/Marcco/image1.png'),
          memory1: 'Marcco',
          memory1ID: 24,
          image2: require('../../assets/Images/Memories/Marcco/image2.png'),
          memory2: 'Marcco',
          memory2ID: 24,
          image3: require('../../assets/Images/Memories/Marcco/image3.png'),
          memory3: 'Marcco',
          memory3ID: 24,
          image4: require('../../assets/Images/Memories/Marcco/image1.png'),
          memory4: 'Marcco',
          memory4ID: 24,
          image5: require('../../assets/Images/Memories/Marcco/image2.png'),
          memory5: 'Marcco',
          memory5ID: 24,
          image6: require('../../assets/Images/Memories/Marcco/image3.png'),
          memory6: 'Marcco',
          memory6ID:24,
        },
        set2: {
