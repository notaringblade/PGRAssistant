...
const CombatTab = ({route}) =>{
    ...
    return(
        ...
        <CollapsibleView title={<Text style={styles.titleText}>Orbs</Text>} style={styles.collapsedView} initExpanded={true} noArrow={true} >
            <CollapsibleView title={<Text style={styles.titleText}>Red Orb</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Yellow Orb</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Blue Orb</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
        ...
        <CollapsibleView title={<Text style={styles.titleText}>Skills</Text>} style={styles.collapsedView} initExpanded={false} noArrow={true}  >
            <CollapsibleView title={<Text style={styles.titleText}>Basic Atack</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Signature</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>QTE</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Class</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Awakening</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
        ...
        <CollapsibleView title={<Text style={styles.titleText}>Passives</Text>} style={styles.collapsedView} initExpanded={false} noArrow={true}  >
            <CollapsibleView title={<Text style={styles.titleText}>Core</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>Leader</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>SS Rank</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
            ...
            <CollapsibleView title={<Text style={styles.titleText}>SSS Rank</Text>} style={styles.collapsedView} noArrow={false} arrowStyling={{color : '#3D3D3D'}}>
