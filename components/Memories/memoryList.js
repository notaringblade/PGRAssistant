export default [
  //Condelina
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Condelina/image2.png"),
  ...
  //Shakespeare
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Shakespeare/image2.png"),
    ...
    Story:{
      I: "A prolific writer with words endow'd; He seeded great minds of the Golden Age; Some WGAA thinkers see him as the trend-; -maker of mechanoid restoration; His talents unmatched, and it little fades; In heat of battle, or the fiery page.",
      II: "Though now a memory, his quill ain't still; Penning odes lovely, hateful, humanly; A chance meeting with a commandant gray; \n'A spark!' Says he, and vanished since that shrill."
    }
  },
  //Heisen
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Heisen/image2.png"),
  ...
  //Darwin
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Darwin/image2.png"),
  ...
  //Hanna
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Hanna/image2.png"),
  ...
  //Cottie
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Cottie/image2.png"),
    ...
    Story:{
      I: "Cottie died at the age of 86 from diabetic complications caused by donut overdose. It is said that she passed away peacefully right after she ordered a donut delivery. Cottie's religious obsession with donuts was deemed military-grade, and so she was made into a memory chip.",
      II: "Cottie rewarded Syndicute members with donuts for their hard work, and this caused their overall blood sugar levels and weight to rise. Now, without a body, she is constantly scheming about spreading her fried dough addiction to the commandant."
    }
  },
  //DaVinci 
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/DaVinci/image2.png"),
  ...
  //Catherine
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Catherine/image2.png"),
    ...
    Story:{
      I: "When Catherine was still human, she was the owner of Rose Garden. The details of Rose Garden did not survive the trials of time, but according to Catherine, it was located in a valley, and the windows were covered by deep red drapes, so that people inside would not notice the flow of time. Catherine spent her whole life in the garden alone, during which only one mysterious person visited.",
      II: "Catherine is a medical professional who understands true pain and loneliness. This is why she wants to protect her friends from the suffering she felt before. When she met the commandant for the first time, it brought back some memories to her. But without a body, they seem to hardly matter anymore."
    }
  },
  //Einsteina
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Einsteina/image2.png"),
    ...
    Story:{
      I: "When she was still human, she completed the fundamental theoretical framework for space colonization, taking scientific development to a whole new level. Her knowledge of material properties is also immensely helpful in battle.",
      II: "Real mad for cute lasses, even physical death could not part her from her cute-is-justice philosophy. She has been continuing with her research, but is refusing to share the results with Asimov. After all, Asimov is still quite a ways from being a cute girl."
    }
  },
  //PhilipII
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/PhilipII/image2.png"),
    ...
    Story:{
      I: "Philip II was born into a military family and received strict a military education since her childhood. But why make war, when you can make art? The military and industrial sectors may have been thriving during the Golden Age, but to pursue the sublime heights, and to soothe the spirits of the people, Philip II left her family at a young age to join the newly established WGAA. Her flute performance is said to be quite a feast for the ears.",
      II: "Philip II loves performing on stage. A master of various musical performance styles, she can easily comfort the minds of her audience. President Allen is currently preparing a concert for Philip II and other virtual idols."
    }
  },
  //Guinevere
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Guinevere/image2.png"),
  ...
  //Frederick
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Frederick/image2.png"),
  ...
  //Patton
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Patton/image2.png"),
  ...
  //Bathlon
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Bathlon/image2.png"),
  ...
  //Zuwenyuan
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Zuwenyuan/image2.png"),
  ...
  //Leeuwenhoek
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Hoek/image2.png"),
  ...
  //Flamel
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Flamel/image2.png"),
  ...
  //Tifa
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Tifa/image2.png"),
  ...
  //Elizabeth
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Elizabeth/image2.png"),
  ...
  //Seraphine
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Seraphine/image2.png"),
  ...
  //Koya
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Koya/image2.png"),
  ...
  //WuAnjun
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/WuAnjun/image2.png"),
  ...
  //Lurcezia
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Lurcezia/image2.png"),
  ...
  //Jack
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Jack/image2.png"),
  ...
  //Marcco
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Marcco/image2.png"),
  ...
  //Erwin
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Erwin/image2.png"),
    ...
    Story:{
      I: "When Erwin was small, she longed to be an engineer. She was, however, forced to serve in the army due to family reasons. Her talents were unrestricted by her poor health, though her luck was notoriously bad. On the battlefield, her sophisticated tactics have helped turned the tide of innumerable battles.",
      II: "Now, Erwin supervises the commandant's practices in her spare time, though she will soft-heartedly and reluctantly end the practice earlier when the commandant begs her."
    }
  },
  //Aife
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Aife/image2.png"),
  ...
  //Ike
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Ike/image2.png"),
  ...
  //Voltaire
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Voltaire/image2.png"),
  ...
  //Gloria
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Gloria/image2.png"),
  ...
  //Richelieu
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Richelieu/image2.png"),
    ...
    Story:{
      I: "When Richelieu was still human, she was one of the cardinals in the early Golden Age. Foreseeing that religion would lose its appeal, she proposed creating bionic robots for religious services, yet it was met with the opposition of the church. Only when her predictions proved true did the churches hastily activate the batch of mechanical members created by Richelieu. It is worth noting that Richelieu's medical techniques were unmatched among all the churches.",
      II: "Richelieu was not surprised by the church's stance—she predicted that as well. Now, she has a new and gratifying mission in helping Babylonia with diplomatic relations with different factions."
    }
  },
  //Samantha
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Samantha/image2.png"),
    ...
    Story:{
      I: "When Samantha was still human, she gravitated towards various animals since her childhood. This fact, along with her aristocratic upbringing, it was no wonder that she became the manager of the urban ecology research center.",
      II: "Now, in addition to providing medical help as a memory chip, Babylonia's ecology research center is her second home."
    }
  },
  //Mozart
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Mozart/image2.png"),
    ...
    Story:{
      I: "When Mozart was still human, she loved collecting musical works created before the Golden Age. By combining and remixing them, she pioneered a whole new genre that changed Golden Age music. Now, Mozart's tunes, from relaxing to soul-stirring, are all classics and staples on Square Wave Radio.",
      II: "In addition to her musical contribution, Mozart is also somewhat of a gourmet. Yet, without a physical body, the sweet succulent taste of fried pork chops will never graze her taste buds again."
    }
  },
  //Boudica
  {
    ...
    Artwork: {
      Grid2: require("../../assets/Images/Memories/Boudica/image2.png"),
